...
Gracias a estos metadatos se representa una forma de hibridación ya que en las obras físicas su autenticidad se mostraba por el nombre y firma del autor como señal de autenticidad. Ahora gracias a los metadatos y a la blockchain, es imposible de falsificar las obras de arte digitales, ya que se almacena toda la información sobre su autoría en la red.
...
En la actualidad desconocemos los tipos de activos digitales que pueden utilizar este tipo de tecnología, ya que nos encontramos ante un número indeterminado de tokens no fungibles que pueden serlo. Así pues, podemos destacar una relación con los NFT, como por ejemplo, el metaverso, donde puede existir juegos crypto interconectados.
...
Como dice Lev Manovich, ‘un híbrido puede definir nuevas técnicas de navegación e interacción que funcionan con formatos de medios no modificados’ por lo tanto, en el caso del NFC, tenemos la técnica habitual del pago con tarjeta, pero esta vez no funciona mediante inserción por chip, si no que funciona por ondas electromagnéticas. Gracias a la función NFC podemos albergar las tarjetas físicas que tenemos en nuestra cartera, en una wallet digital en nuestro teléfono móvil, y así mediante contacto NFC realizar el pago. De esta forma tenemos una hibridación al usar las tarjetas físicas como digitales.
...
[https://www.xataka.com/moviles/nfc-que-es-y-para-que-sirve](https://www.xataka.com/moviles/nfc-que-es-y-para-que-sirve)
